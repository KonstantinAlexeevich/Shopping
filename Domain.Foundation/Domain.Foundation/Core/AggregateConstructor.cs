...
{
    public class AggregateConstructor : IAggregateConstructor
    {
        ...
        public AggregateConstructor(IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
        }

        public Task<TAggregate> CreateInstanceAsync<TAggregate, TIdentity>(TIdentity id)
